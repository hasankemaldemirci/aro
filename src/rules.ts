...
## Project
${data.projectName} v${data.version} | Framework: ${data.framework}
Tech Stack: ${data.techStack.join(", ") || "Node.js"}
...
- Force push, reset --hard: always ask

## Key Constraints
- Keep files under 300 lines (ARO standard)
- Run \`aro audit\` before committing to maintain score
